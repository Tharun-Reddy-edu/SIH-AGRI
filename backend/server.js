...
async function initializePaymentTables() {
  ...
  */
  ...
  /*
    Existing databases may already
    have these columns.
  */
...
/* =========================================================
   PRODUCER-CONSUMER SMART MATCHING
========================================================= */
      ...
      const matches =
        result.rows
          ...
          .filter((listing) => {
            ...
            /*
              If buyer specifies maximum price,
              don't show listings above it.
            */
            ...
            return {
              ...
              match_reasons: {
                ...
                quantity:
                  listingQuantity >=
                  requestedQuantity
                    ? "Can fulfill requested quantity"
                    : `Can supply ${listingQuantity} ${listing.unit}`,
                ...
                price:
                  maximumPrice === null
                    ...
                    : listingPrice <=
                      maximumPrice
                    ? "Within your maximum price"
                    : "Above your maximum price",
    ...
    try {
      ...
      if (
        ...
        if (!isBuyer && !isFarmer) {
          ...
          return res.status(403).json({
            message:
              "Only the buyer or farmer can confirm pickup"
          });
        }
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (
        ...
        return res.status(403).json({
          message:
            "You can only update orders for your own listings"
        });
      }
      ...
      if (
        ...
        return res.status(400).json({
          message:
            "Order can be completed only after delivery is marked delivered"
        });
      }
...
/*
  ...
  Crop-quality AI is a separate feature and runs
  only after the farmer uploads a crop image.
*/
